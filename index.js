...
const main = async (action) => {
  ...
  await context.overridePermissions("https://cloud.nueip.com/login", [
    "geolocation",
  ]);
  ...
  // Latitude: 25.02280096442388 Longitude: 121.54923719041534
  await page.setGeolocation({
    latitude: 25.02280096442388,
    longitude: 121.54923719041534,
  });
